...
//        codeMirrorView.setDarkMode(on: false)
...
//        codeMirrorView.setTabSize(4)
    ...
    func codeMirrorViewDidLoadSuccess(_ sender: CodeMirrorWebView) {
        ...
        let completions =  [["label" : "fetchRecords()", "type" : "function", "class" : "form"],
                            ["label" : "getFormIdsByName", "type" : "function", "class" : "document"],
                            ["label" : "getFormNamed", "type" : "function", "class" : "document"],
                            ["label" : "getForms", "type" : "function", "class" : "document"],
                            ["label" : "getFormWithId", "type" : "function", "class" : "document"],
        ...
        let snippets = [
            ["createNewFormNamed('${Form Name}');" : ["label" : "createNewFormNamed", "type" : "function", "class" : "form"]],
...
private let exampleTexts: [String: String] = [
    ...
    "javascript": """
        ...
        var totalzz_id = 'fld-5eadb74b0da04895bd3930de53c29eb2';
        var class_name_id = 'fld-7b7d09bd4544426ba0b3ef727081d892';
        var totalzz = record.getFieldValue(totalzz_id);
        
        for (var index = 0, count = totalzz.length; index < count; index++){
         var class_name = totalzz[index].getFieldValue(class_name_id);
        if (class_name) {
            // do something
        }
        }
